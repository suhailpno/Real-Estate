    ...
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 z-10">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <h1 className="font-display text-5xl md:text-7xl lg:text-8xl text-gradient mb-6 animate-fade-in leading-tight">
            Welcome to <br/><span className="text-gradient-gold">FayaDeen Realty</span>
          </h1>
          <p className="text-white/80 text-lg md:text-xl mb-8 leading-relaxed animate-fade-in max-w-2xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-6 animate-fade-in">
            <Button className="bg-secondary hover:bg-secondary/90 text-white px-8 py-6 rounded-lg text-lg w-full md:w-auto hover-up group">
              Discover Properties
